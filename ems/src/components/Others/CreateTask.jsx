            ...
            <form onSubmit={submitHandler} className="flex flex-wrap w-full items-start justify-between">
                <div className="w-1/2 flex flex-col gap-4 px-2">
                    <div>
                        ...
                        <input value={taskTitle} onChange={(e)=>setTaskTitle(e.target.value)} className="w-full bg-transparent border-gray-600 border py-2 px-4 rounded" type="text" placeholder="Task Name" />
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        {/* Modified with datalist for employee selection */}
                        <input list="employee-list" value={assignTo} onChange={(e)=>setAssignTo(e.target.value)} className="w-full bg-transparent border-gray-600 border py-2 px-4 rounded" type="text" placeholder="Start typing name..." />
                ...
                <div className="w-1/2 flex flex-col px-2">
                    ...
                    <button className="w-full mt-4 bg-emerald-500 py-3 rounded font-bold hover:bg-emerald-600">Create Task</button>
                </div>
            </form>
        </div>
    )
